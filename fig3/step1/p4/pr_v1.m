...
for f=1:ncfilenumber
    st_clim=ncread([path ncfile(f).name],'pr')*86400;
    ...
    pr_year1(:,:,:,f)=squeeze(Xeventss(:,:,before+2,:));
% Xeventss_all(:,:,:,:,f)=Xeventss;
end

 save pr_year1_20mjjas.mat pr_year1;
% save pr_wj_10djf.mat Xeventss_all;
