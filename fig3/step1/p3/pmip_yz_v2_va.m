clear all; clc;
%%
path='E:\1_work_moreVols\data\pmip3_va\';
%% GAO
q00=ncread([path '2va850_ccsm4_085101-184912.nc'],'va');
st_clim(:,:,:,1)=q00;clear q00;
q00=ncread([path '2va850_ipsl_085101-184912.nc'],'va'); 
st_clim(:,:,:,2)=q00;clear q00;
q00=ncread([path '2va850_fgoasl_085101-184912.nc'],'va');
st_clim(:,:,:,3)=q00;clear q00;
q00=ncread([path '2va850_mri_085101-184912.nc'],'va');
st_clim(:,:,:,4)=q00;clear q00;
q00=ncread([path '2va850_bcc_085101-184912.nc'],'va');
st_clim(:,:,:,5)=q00;clear q00;
%% CROWLEY
% q00=ncread([path '2va850_csiro_085101-184912.nc'],'va');
% st_clim(:,:,:,1)=q00;clear q00; 
% q00=ncread([path '2va850_mpi_085101-184912.nc'],'va');
% st_clim(:,:,:,2)=q00;clear q00;
% q00=ncread([path '2va850_giss_085101-184912.nc'],'va');
% st_clim(:,:,:,3)=q00;clear q00;
% q00=ncread([path '2va850_hadcm_085101-184912.nc'],'va');
% st_clim(:,:,:,4)=q00;clear q00;
% q00=ncread([path '2va850_miroc_085101-184912.nc'],'va');
% st_clim(:,:,:,5)=q00;clear q00;
...
pmip_va_year1=Xeventss(:,:,before+2,:,:);

save pmip_va_year1_7mjjasGao.mat pmip_va_year1;
