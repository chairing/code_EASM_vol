clear all; clc;
%%
path='E:\1_work_moreVols\data\pmip3_sst\';
%% GAO
% q00=ncread([path '2tos_ccsm4_085101-184912.nc'],'tos');
% st_clim(:,:,:,1)=q00;clear q00;
% q00=ncread(['E:\1_work_moreVols\data\pmip3\2ts_Amon_IPSL-CM5A-LR_past1000_r1i1p1_085001-184912.nc'],'ts'); %% no sst data
% st_clim(:,:,:,2)=q00(:,:,13:(1849-850+1)*12);clear q00;
% q00=ncread([path '2tos_fgoasl_085101-184912.nc'],'tos');
% st_clim(:,:,:,3)=q00;clear q00;
% q00=ncread([path '2tos_mri_085101-184912.nc'],'tos');
% st_clim(:,:,:,4)=q00;clear q00;
% q00=ncread([path '2tos_bcc_085101-184912.nc'],'tos');
% st_clim(:,:,:,5)=q00;clear q00;
%% CROWLEY
q00=ncread([path '2tos_csiro_085101-184912.nc'],'tos');
st_clim(:,:,:,1)=q00;clear q00; 
q00=ncread([path '2tos_mpi_085101-184912.nc'],'tos');
st_clim(:,:,:,2)=q00;clear q00;
q00=ncread([path '2tos_giss_085101-184912.nc'],'tos');
st_clim(:,:,:,3)=q00;clear q00;
q00=ncread([path '2tos_hadcm_085101-184912.nc'],'tos');
st_clim(:,:,:,4)=q00;clear q00;
q00=ncread([path '2tos_miroc_085101-184912.nc'],'tos');
st_clim(:,:,:,5)=q00;clear q00;
...
% %% Crowley
% %key_dates_Cro=[971;1229;1258;1286;1456;1674;1696;1809;1816;1835];
...
pmip_sst_year1=Xeventss(:,:,before+2,:,:);

save pmip_sst_year1_6mjjasGao.mat pmip_sst_year1;
